...
*Be sure to check out our [Wiki Page](https://github.com/djacidfx/Earning-Social-Platform-Project/wiki), We also have a [discussion](https://github.com/djacidfx/Earning-Social-Platform-Project/discussions) page if you want to interact with the community, [Click Here](https://github.com/djacidfx/Earning-Social-Platform-Project/blob/main/CONTRIBUTORS.md) to check out the awesome people who helped make this dream become a reality and check out our [Kickstarter Page](https://www.kickstarter.com/projects/wildcatstudio/earning-social-platform-project) or [Buy Me A Coffee](https://buymeacoffee.com/wildcatstudio) Page for if you want to show some support!*

*If you find any errors or inconsistancies please, let us know in a dicussion so we can fix it. We are trying to keep everything up to date between here, buy me a coffee, Kickstarter page and others as best as possible so bear with us*
